        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="jumbotron">
                    ...
                    <hr>
                    <a href="php/memori.php"><h2><span class="fas fa-brain"></span><span class="tab-text">  Juego de Memoria con Números</h2></span></a>
                    <a href="php/memoricolor.php"><h2><span class="fas fa-brain"></span><span class="tab-text">  Juego de Memoria con Colores</h2></span></a>
